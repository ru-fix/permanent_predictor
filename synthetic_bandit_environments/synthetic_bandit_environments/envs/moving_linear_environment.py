...
class MovingLinearEnvironment(gym.Env):
    ...
    def __init__(
        ...
        super(MovingLinearEnvironment, self).__init__()
    ...
    def __get_reward_range(self, arm_range, context_range, arm_error_params, context_size):
        borders = [arm_border * context_border * context_size + variance_border
    ...
    def __calculate_rewards(self):
        ...
        rewards = np.dot(self.contexts[self.index], self.arms.T) + self.arm_errors[self.index]
